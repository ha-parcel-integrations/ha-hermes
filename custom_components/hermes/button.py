"""Button platform for the Hermes parcel tracker integration."""
...
async def async_setup_entry(
    ...
    """Set up the Hermes refresh button from a config entry."""
    async_add_entities([HermesRefreshButton(entry)])


class HermesRefreshButton(ButtonEntity):
    """Button that forces an immediate poll of all tracked Hermes parcels."""
